...
public class Doublecolumn {
    ...
    public static void main(String[] args) {
        ...
        int iKey2[] = convertKey(sKey2);
        int iCopyKey2[] = iKey2.clone();
        int iIndexKey2[] = sortKey(iCopyKey2);

        System.out.println("Enter PlainText");
        String sPlainText = scn.nextLine().replaceAll(" ", "");

        String sCipherText = colEncrypt(sPlainText, iKey, iIndexKey);
        sCipherText = colEncrypt(sCipherText, iKey2, iIndexKey2);
        
        String sDecipherText = colDecrypt(sCipherText, iKey2, iIndexKey2);
        sDecipherText = colDecrypt(sDecipherText, iKey, iIndexKey);
